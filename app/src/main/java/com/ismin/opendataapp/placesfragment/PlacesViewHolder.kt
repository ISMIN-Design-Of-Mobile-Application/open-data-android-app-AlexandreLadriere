...
class PlacesViewHolder(rootView: View, private val selectPlace: (Int) -> Unit) : RecyclerView.ViewHolder(rootView) {
    ...
    private var container: ConstraintLayout = rootView.findViewById(R.id.recycler_view_place_constraint_layout)
